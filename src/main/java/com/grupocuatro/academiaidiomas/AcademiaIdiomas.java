...
public class AcademiaIdiomas {
    ...
    public static void main(String[] args) {
        ...
        Alumno alumno4 = new Alumno("Luis", "Hernandez", 8, "bbsshgcfdf", "afafafaf", "111111111");

        al.agregarAlumno(alumno1);
        al.agregarAlumno(alumno2);
        al.agregarAlumno(alumno3);
        al.agregarAlumno(alumno4);

        Alumno alumnoMostrado = al.mostrarAlumnos(1);
        System.out.println(alumnoMostrado);*/
        //al.eliminarAlumno(15);
        /**alumnoMostrado = al.mostrarAlumnos(4);
        System.out.println(alumnoMostrado);
        System.out.println(" ");
        al.listarAlumnos();*/
    }
